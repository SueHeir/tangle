...
def ct_rasterize(
    ...
    labels: Any, distance: Any, segment: Any, ratios: list[float] | None = ..., axes: Any | None = ...,
) -> None: ...
def ct_paint(target: Any, line: Any, reach: float, value: int, only_empty: bool, ratio: float = ..., axes: Any | None = ...) -> None: ...
...
def ct_render_occupancy(low: Sequence[int], high: Sequence[int], nodes: Any, counts: list[int], radii: list[float], edge: float, out: Any, ratios: list[float] | None = ..., axes: Any | None = ...) -> None: ...
