...
class NeighborReport:
    ...
    def contact_graph(self) -> dict[str, Any]: ...
    def to_json(self, pretty: bool = ...) -> str: ...
    def to_dict(self) -> dict[str, Any]: ...
    def write_json(self, path: Path) -> None: ...
...
class Scorecard:
    ...
    def schema_version(self) -> int: ...
    @property
    def subvolume_size(self) -> list[float]: ...
    @property
    def reference_subvolume_count(self) -> int: ...
    @property
    def candidate_subvolume_count(self) -> int: ...
    @property
    def min_piece_length(self) -> float: ...
    @property
...
def score_structure(
    ...
    *,
    ...
    candidate_region: tuple[Point, Point] | None = ...,
    reference_region: tuple[Point, Point] | None = ...,
    max_candidate_subvolumes: int = ...,
    min_piece_length: float | None = ...,
    sample_spacing: float | None = ...,
    neighbor_sample_spacing: float | None = ...,
    neighbor_gap: float | None = ...,
    in_axis_angle_degrees: float = ...,
