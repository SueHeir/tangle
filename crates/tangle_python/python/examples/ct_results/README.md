...
Gaussian point-spread function of 0.9 voxels (0.7–1.2 in the varied
structures, 1.05 in `dense_crossing`, cut from `varied_3`) before noise is added. Where fibers touch, the blur fills the
...
the blur set to 0.45 or 0 voxels for all of them (`python ct_examples.py --varied --blur 0.45`, and
`--blur 0`):

| Example (its default blur) | Default blur | Blur 0.45 | No blur |
| --- | --- | --- | --- |
| `varied_3` (dense cross-ply, 1.05) | 128/200, F1 0.863 | 180/200, F1 0.978 | **199/200, F1 0.992** |
| `dense_crossing` (1.05) | 34/55, F1 0.810 | 47/55, F1 0.911 | **53/55, F1 0.981** |
| `two_types` (0.9) | 96/116, F1 0.886 | 105/116, F1 0.929 | **107/116, F1 0.942** |
| `varied_4` (1.11) | 123/152, F1 0.942 | **152/152, F1 0.998** | 151/152, F1 0.991 |
| `varied_6` (0.94) | 123/146, F1 0.937 | 137/146, F1 0.972 | **140/146, F1 0.978** |
| `varied_2` (0.9) | 110/117, F1 0.966 | **115/117, F1 0.996** | 113/117, F1 0.990 |
| `varied_1` (0.79) | 96/105, F1 0.982 | 101/105, F1 0.990 | **104/105, F1 0.993** |
...
**Blur, not the method, is what limits the dense cases.** At blur 0.45,
the densest structure goes from the worst result to F1 0.98. Without
