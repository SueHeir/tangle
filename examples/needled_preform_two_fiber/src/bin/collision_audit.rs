//! Exhaustive host-side collision audit for a saved needled-preform checkpoint.
...
const CASE_ID: &str = "needled_preform_two_fiber-v19-staged-solve-policy";
    ...
    let path = std::env::args_os()
        ...
        .unwrap_or_else(|| {
            PathBuf::from(env!("CARGO_MANIFEST_DIR"))
                .join("output/needled_preform_two_fiber.restart")
        });
