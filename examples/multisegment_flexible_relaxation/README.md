...
Start with the **[Python notebook](../../crates/tangle_python/python/examples/native/multisegment_flexible_relaxation.ipynb)**
or [editable script](../../crates/tangle_python/python/examples/native/multisegment_flexible_relaxation.py).
...
```console
cargo run -p multisegment_flexible_relaxation
```
...
```console
cargo run -p multisegment_flexible_relaxation -- --debug-ovito
```
