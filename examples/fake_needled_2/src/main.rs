...
//! relatively bend-resistant fibers and 19 µm comparatively bendy fibers.
...
fn main() {
    ...
    let checkpoint_path = output.directory.join("fake_needled_2.restart");
...
fn random_needle_center(layer: u32) -> [f32; 2] {
...
fn thin_stiff_fibers() -> FiberPopulationSpec {
    FiberPopulationSpec {
        ...
        ..common_population("7 um stiff fiber", 20_260_938)
    }
}
...
fn thick_bendy_fibers() -> FiberPopulationSpec {
    FiberPopulationSpec {
        ...
        ..common_population("19 um bendy fiber", 20_260_939)
    }
}
...
fn report(app: &App) {
    ...
    println!("fake needled 2.0 physical-scale recipe:");
    println!(
