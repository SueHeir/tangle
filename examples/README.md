...
| Fitting fibers to CT scans | [ct_examples](../crates/tangle_python/python/examples/ct_examples.py) | Python only; [results with pictures](../crates/tangle_python/python/examples/ct_results/README.md) |
