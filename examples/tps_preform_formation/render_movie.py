"""Render the TPS-preform OVITO trajectory to an MP4."""
...
pipeline.modifiers.append(
    ColorCodingModifier(
        property="curvature_ratio",
        start_value=0.0,
        end_value=1.0,
    )
)
pipeline.modifiers.append(
    ExpressionSelectionModifier(expression="curvature_ratio > 1.0")
)
pipeline.modifiers.append(
    AssignColorModifier(color=(1.0, 0.0, 0.0))
)
pipeline.add_to_scene(name="TANGLE TPS preform formation")
...
movie_path = OUTPUT / "tps_preform_formation.mp4"
